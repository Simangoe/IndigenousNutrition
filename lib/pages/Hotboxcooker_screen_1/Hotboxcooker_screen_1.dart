...
class Hotboxcooker_screen_1 extends StatefulWidget {
  const Hotboxcooker_screen_1({Key? key}) : super(key: key);

  @override
  _Hotboxcooker_screen_1State createState() => _Hotboxcooker_screen_1State();
}

class _Hotboxcooker_screen_1State extends State<Hotboxcooker_screen_1> {
  @override
...
// Content
                                ...
                                textsubheading('whatarethey'.tr),
                                textbody('largebasketorboxInsulating'.tr),
                                textbody('howtouseitforexample'.tr),
                                textbody('thecookingtimevaries'.tr),
