...
class Adolescentnutritionscreen3 extends StatefulWidget {
  const Adolescentnutritionscreen3({Key? key}) : super(key: key);

  @override
  _Adolescentnutritionscreen3State createState() =>
      _Adolescentnutritionscreen3State();
}

class _Adolescentnutritionscreen3State
    extends State<Adolescentnutritionscreen3> {
  @override
...
//
// Content
                                textheading("adolescentnutrition".tr),

                                Container(
                                  child: Image.asset(
                                      "assets/Screenshot2022-09-11-023906.png",
                                      width: width,
                                      fit: BoxFit.fitWidth),
                                ),

                                textbody('adolescentnutritionbody'.tr),
