...
class Rupiza extends StatefulWidget {
  const Rupiza({Key? key}) : super(key: key);

  @override
  _Rupiza createState() => _Rupiza();
}

class _Rupiza extends State<Rupiza> {
  @override
...
//
// Content
                                textheadingcolor('Rupiza'.tr,
                                    const Color.fromARGB(255, 181, 117, 117)),
                                textbodycolor('introRupiza'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('IngredientsRupiza'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('MethodRupiza'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
