...
class Avocadosweetpotatomilk extends StatefulWidget {
  const Avocadosweetpotatomilk({Key? key}) : super(key: key);

  @override
  _Avocadosweetpotatomilk createState() => _Avocadosweetpotatomilk();
}

class _Avocadosweetpotatomilk extends State<Avocadosweetpotatomilk> {
  @override
...
// Content
                                textheadingcolor(
                                    'AvocadoandSweetPotatoinMilk'.tr,
                                    const Color.fromARGB(255, 181, 117, 117)),
                                textbodycolor('IngredientsAvo'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('MethodAvo'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
