...
class Mbwirembwire extends StatefulWidget {
  const Mbwirembwire({Key? key}) : super(key: key);

  @override
  _Mbwirembwire createState() => _Mbwirembwire();
}

class _Mbwirembwire extends State<Mbwirembwire> {
  @override
...
//
// Content
                                textheadingcolor('Mbwirembwire'.tr,
                                    const Color.fromARGB(255, 181, 117, 117)),
                                textbodycolor('IngredientsMbwire'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('MethodMbwire'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
