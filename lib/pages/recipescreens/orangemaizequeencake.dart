...
class Orangemaizequeencake extends StatefulWidget {
  const Orangemaizequeencake({Key? key}) : super(key: key);

  @override
  _Orangemaizequeencake createState() => _Orangemaizequeencake();
}

class _Orangemaizequeencake extends State<Orangemaizequeencake> {
  @override
...
//
// Content
                                textheadingcolor('Orangemaizequeencake'.tr,
                                    const Color.fromARGB(255, 181, 117, 117)),
                                textbodycolor('Ingredientscake'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('MethodCake'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
