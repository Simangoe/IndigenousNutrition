...
class Nua45bean extends StatefulWidget {
  const Nua45bean({Key? key}) : super(key: key);

  @override
  _Nua45bean createState() => _Nua45bean();
}

class _Nua45bean extends State<Nua45bean> {
  @override
...
//
// Content
                                textheadingcolor('Nua45Bean'.tr,
                                    const Color.fromARGB(255, 181, 117, 117)),
                                textbodycolor('Ingredientsnua'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('Methodnua'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
