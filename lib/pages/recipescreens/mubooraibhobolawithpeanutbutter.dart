...
class Mubooraibhobolawithpeanutbutter extends StatefulWidget {
  const Mubooraibhobolawithpeanutbutter({Key? key}) : super(key: key);

  @override
  _Mubooraibhobolawithpeanutbutter createState() =>
      _Mubooraibhobolawithpeanutbutter();
}

class _Mubooraibhobolawithpeanutbutter
    extends State<Mubooraibhobolawithpeanutbutter> {
  @override
...
// Content
                                textheadingcolor(
                                    'Muboora/ibhobolawithpeanutbutter'.tr,
                                    const Color.fromARGB(255, 181, 117, 117)),
                                textbodycolor('Ingredientsmuboora'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('Methodmuboora'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
