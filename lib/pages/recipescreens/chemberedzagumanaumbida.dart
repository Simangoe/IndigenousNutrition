...
class Chemberedzagumanaumbida extends StatefulWidget {
  const Chemberedzagumanaumbida({Key? key}) : super(key: key);

  @override
  _Chemberedzagumanaumbida createState() => _Chemberedzagumanaumbida();
}

class _Chemberedzagumanaumbida extends State<Chemberedzagumanaumbida> {
  @override
...
//
// Content
                                textheadingcolor('Chemberedzagumana/umbida'.tr,
                                    const Color.fromARGB(255, 181, 117, 117)),
                                textbodycolor('IngredientsChembere'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('MethodChembere'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
