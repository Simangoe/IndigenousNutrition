...
class Pumpkinporridgeenrichedwitheggsandsweetpotatoes extends StatefulWidget {
  const Pumpkinporridgeenrichedwitheggsandsweetpotatoes({Key? key})
      : super(key: key);

  @override
  _Pumpkinporridgeenrichedwitheggsandsweetpotatoes createState() =>
      _Pumpkinporridgeenrichedwitheggsandsweetpotatoes();
}

class _Pumpkinporridgeenrichedwitheggsandsweetpotatoes
    extends State<Pumpkinporridgeenrichedwitheggsandsweetpotatoes> {
  @override
...
// Content
                                textheadingcolor(
                                    'Pumpkinporridgeenrichedwitheggs,andsweetpotatoes'
                                        .tr,
                                    const Color.fromARGB(255, 181, 117, 117)),
                                textbodycolor('Ingredientspumpkin'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('Methodpumpkin'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
