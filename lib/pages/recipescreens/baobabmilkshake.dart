...
class Baobabmilkshake extends StatefulWidget {
  const Baobabmilkshake({Key? key}) : super(key: key);

  @override
  _Baobabmilkshake createState() => _Baobabmilkshake();
}

class _Baobabmilkshake extends State<Baobabmilkshake> {
  @override
...
// Content
                                textheadingcolor(
                                    'Baobabmilkshake/Mawuyu-umkhomomilkshake'
                                        .tr,
                                    const Color.fromARGB(255, 181, 117, 117)),
                                textbodycolor('Ingredientsmilkshake'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
                                textbodycolor('Methodmilkshake'.tr,
                                    const Color.fromARGB(179, 0, 0, 0)),
