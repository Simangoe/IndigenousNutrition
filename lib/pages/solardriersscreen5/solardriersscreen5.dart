...
class Solardriersscreen5 extends StatefulWidget {
  const Solardriersscreen5({Key? key}) : super(key: key);

  @override
  _Solardriersscreen5State createState() => _Solardriersscreen5State();
}

class _Solardriersscreen5State extends State<Solardriersscreen5> {
  @override
...
//
// Content
                                textheading('SOLAR DRIERS'.tr),
                                textsubheading('What are they?'.tr),
                                Container(
                                    child: Image.asset(
                                        "assets/image_ImageView_89-340x175.png",
                                        width: width,
                                        fit: BoxFit.fitWidth)),
                                textbody(
                                    'solardriersarebasiclowcosttechnology'.tr),
                                textbody('materials10x3point3mbrandering'.tr),
                                textbody(
                                    'methodensureaccuracyofthecutpieces'.tr),
