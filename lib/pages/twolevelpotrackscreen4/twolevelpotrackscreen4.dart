...
class Twolevelpotrackscreen4 extends StatefulWidget {
  const Twolevelpotrackscreen4({Key? key}) : super(key: key);

  @override
  _Twolevelpotrackscreen4State createState() => _Twolevelpotrackscreen4State();
}

class _Twolevelpotrackscreen4State extends State<Twolevelpotrackscreen4> {
  @override
...
//
// Content
                                textheading('TWO LAYERED POTRACK'.tr),
                                Container(
                                    child: Image.asset(
                                        "assets/image_ImageView_57-310x220.png",
                                        width: width,
                                        fit: BoxFit.fitWidth)),
                                textbody('woodenpotrackmaterials'.tr),
                                textbody(
                                    'methodmeasure4poleswhichare2metreslong'
                                        .tr),
                                Container(
                                    child: Image.asset(
                                        "assets/image_ImageView_59-288x263.png",
                                        width: width,
                                        fit: BoxFit.fitWidth)),
                                textbody('bricklayeredpotrack'.tr),
// End of Content
//
