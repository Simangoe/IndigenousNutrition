...
class Claypotfridgescreen3 extends StatefulWidget {
  const Claypotfridgescreen3({Key? key}) : super(key: key);

  @override
  _Claypotfridgescreen3State createState() => _Claypotfridgescreen3State();
}

class _Claypotfridgescreen3State extends State<Claypotfridgescreen3> {
  @override
...
//
// Content
                                textheading('CLAYPOT FRIDGE'.tr),
                                textbody('type1materials'.tr),
                                textbody('methodwetthepotandthecloth'.tr),
                                Container(
                                    child: Image.asset(
                                        'assets/image_ImageView_62-335x146.png')),
                                textbody('type2materials'.tr),
                                textbody('methodobtaintwolargeclaypots'.tr),
                                textbody('pleasenotevegetables'.tr),
// End of Content
//
