...
class EarthOvenScreen extends StatefulWidget {
  const EarthOvenScreen({Key? key}) : super(key: key);

  @override
  _EarthOvenScreen createState() => _EarthOvenScreen();
}

class _EarthOvenScreen extends State<EarthOvenScreen> {
  @override
...
//
// Content
                                textheading('EARTH/GROUND OVEN'),
                                textbody('anyfoodcanbe'.tr),
                                textbody('bricksstonescowdung'.tr),
                                textbody('digthepit90cmlengthx70cm'.tr),
// End of Content
//
