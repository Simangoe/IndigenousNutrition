...
final pdfController = PdfController(
  document: PdfDocument.openAsset('assets/cgcouncelingcards.pdf'),
);

class cgcounseling extends StatefulWidget {
  const cgcounseling({Key? key}) : super(key: key);

  @override
  _cgcounseling createState() => _cgcounseling();
}

class _cgcounseling extends State<cgcounseling> {
